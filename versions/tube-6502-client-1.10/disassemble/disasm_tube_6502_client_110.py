...
comment(0xFEF0, "Addresses &FEF0-&FEF7 are active but")
comment(0xFEF0, "unused by the Tube Client software.")
comment(0xFEF0, "Tube ULA address space (no register)", inline=True)
comment(0xFEF1, "Tube ULA address space (no register)", inline=True)
comment(0xFEF2, "Tube ULA address space (no register)", inline=True)
comment(0xFEF3, "Tube ULA address space (no register)", inline=True)
comment(0xFEF4, "Tube ULA address space (no register)", inline=True)
comment(0xFEF5, "Tube ULA address space (no register)", inline=True)
comment(0xFEF6, "Tube ULA address space (no register)", inline=True)
comment(0xFEF7, "Tube ULA address space (no register)", inline=True)
